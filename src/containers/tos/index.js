    ...
    <div className="flex flex-col items-center">
      <div className="w-3/4">
        ...
        <p className="mb-5">
          ...
          are accepting these Terms and using Cheersly on behalf of a company,
          organization, or other legal entity, you represent and warrant that
          you are authorized to do so.
        </p>

        <p className="font-bold mt-10 mb-2">The Service</p>
        ...
        <p className="mb-5">
          ...
          and will not provide support for the Cheersly Service. This Agreement
          does not apply to your use of the Slack services.
        </p>

        <p className="font-bold mt-10 mb-2">Payments</p>

        <p className="mb-5">
          Our billing and payments processing infrastructure is on Stripe{" "}
          <a href="https://www.stripe.com" rel="noopener noreferrer">
            (https://www.stripe.com)
          </a>
          .
        </p>

        <p className="font-bold mt-10 mb-2">Refund policy</p>
        ...
        <p className="font-bold mt-10 mb-2">License to use website</p>
        ...
        <p className="font-bold mt-10 mb-2">You must not:</p>
        ...
        <p className="font-bold mt-10 mb-2">Acceptable use</p>
        ...
        <p className="font-bold mt-10 mb-2">Using Service</p>
        ...
        <p className="mb-5">
          ...
          limited to, doing the following: - Using the Service for any unlawful
          purposes or activities; - uploading any content to the Service in
          violation of any applicable law, including but not limited to,
          intellectual property laws and publicity laws; - accessing or
          tampering with the Service’s server systems; - interfering with or
          disrupting the access of any user, host, or network; - abusing or
          submitting excessively frequent requests to the Service via the API or
          via the Slack Messenger.
        </p>
        ...
        <p className="font-bold mt-10 mb-2">Changes to services</p>
        ...
        <p className="font-bold mt-10 mb-2">Amendments</p>
        ...
        <p className="mb-5">
          ...
          Service and/or by emailing you. The revised version will be effective
          at the time we post it to the website or otherwise notify you. Your
        ...
        <p className="font-bold mt-10 mb-2">Termination</p>
        ...
        <p className="mb-5">
          ...
          consequential, exemplary, or punitive damages under any circumstances.
        </p>
        ...
        <p className="mb-5">
          ...
          <ul className="list-disc ml-5">
            ...
            <li>
              the Service will be error-free and all errors in the service will
              be corrected;
            </li>
        ...
        <p className="mb-5">
          ...
          solely responsible for any damage to your computer equipment or
        ...
        <div>
          ...
          <p className="mb-5">
            You represent and warrant that your use of the Cheersly Service will
            be in strict accordance with the Agreement. In particular, you
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                ...
                harmful data, into the Service;
              </li>
              <li>
                you will not infringe our intellectual property rights or those
                of any third party in relation to your use of the Service;
              </li>
              <li>
                ...
                <ul className="list-disc ml-5">
                  ...
                  <li>
                    disclose the name, address, telephone number, e-mail address
                    or any other personal data in respect of any individual
              ...
              <li>
                ...
                content or our systems or attempt to decipher any transmissions
