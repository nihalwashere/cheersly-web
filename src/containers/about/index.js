...
export default function About() {
  return (
    <div className="flex flex-col items-center">
      <div className="w-3/4">
        <h1 className="font-semibold text-4xl text-center mt-20 mb-10">
          About
        </h1>
        ...
        <p className="text-gray-600 mt-4">
          ...
          boring while working from home (alone). We thought of building a Slack
        ...
        <p className="text-gray-600 mt-4">
          ...
          uplift that can increase people’s morale, motivation, engagement and
        ...
        <p className="text-gray-600 mt-4">
          ...
          appreciation, you’re not only boosting performance and engagement, but
        ...
        <p className="text-gray-600 mt-4">
          ...
          better self-esteem, feeling more relaxed and more optimistic. All of
          these emotions creates a pay it forward and “we’re in this together”
          mentality in the workplace, which in turn, makes your organization
          more successful. Plus, the dopamine effect will encourage a continuous
          cycle of recognition if everyone participates. All of these emotions,
          plus many more, are what most employers want out of their staff to
          again, create unity.
        </p>
