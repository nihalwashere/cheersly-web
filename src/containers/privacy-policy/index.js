      ...
      <div className="gutter">
        ...
        <div className="question-and-answer margin-top-20">
            ...
            <ul>
              ...
              <ul>
                <li>
                  ...
                  possible. We would also contact individual users on your team
                  if in case they have shared a feedback.
                </li>
              </ul>
              ...
              <ul>
                <li>
                  ...
                  information, including; message, timestamp and where the
                  message was located (e.g. channel name, channel workspace).
                </li>
              </ul>
            </ul>
          </div>
          ...
          <div className="answer-text margin-top-10">
            ...
            us at support@cheersly.club, and we will remove your data within 30
            days of notice.
          </div>
