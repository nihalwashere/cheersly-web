  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles["landing-header-container"]}>
        <div className={styles["landing-header-text"]}>
          Build cheerful teams in Slack.
        </div>

        <div className={styles["landing-header-description"]}>
          Employee engagement and peer recognition platform to build an awesome
          remote work culture.
        </div>
      </div>
      <div className={styles["landing-feature-problem-root-container"]}>
        <div className={styles["landing-feature-problem-container"]}>
      ...
      <div className={styles["landing-feature-card-container"]}>
        <div className={styles["landing-feature-card-row"]}>
      ...
      <div className={styles["landing-request-early-access-container"]}>
        <div className={styles["landing-request-early-access-header-text"]}>
          Help us shape the future of remote work culture.
        </div>

        <div
          className={styles["landing-request-early-access-button-container"]}
        >
