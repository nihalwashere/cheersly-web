  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`${WEB_BASE_URL}/privacy`} />
      </Head>
        ...
        <div className="gutter">
          ...
          <div className="question-and-answer">
            ...
            <p className="answer-text">
              ...
              <ul>
                <li>
                  We use Heroku as hosting provider in the United States to
                  store and protect your information. They are up to date and
                  setup with the latest security standards and undergo recurring
